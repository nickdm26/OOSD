...
namespace LINQ_ReadFrom_DB
{
	...
	public partial class PoorlyNamedDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeletetblStrike(tblStrike instance);
		...
		public PoorlyNamedDataContext() : 
				base(global::LINQ_ReadFrom_DB.Properties.Settings.Default.IN710_201701_muldnd1ConnectionString1, mappingSource)
		{
			OnCreated();
		}
		
		public PoorlyNamedDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PoorlyNamedDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PoorlyNamedDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PoorlyNamedDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
